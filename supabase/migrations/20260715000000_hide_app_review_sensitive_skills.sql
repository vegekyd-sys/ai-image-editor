-- Temporarily remove third-party football branding and intimate-contact templates
-- from every public Makaron surface while App Store review is in progress.
UPDATE home_skills
SET is_active = false,
    updated_at = now()
WHERE id IN (
