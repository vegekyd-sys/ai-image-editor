...
INSERT INTO token_rates (model_id, display_name, input_per_1m, output_per_1m, markup) VALUES
  ...
  -- Google direct (image output pricing: Flash $30/1M, Pro $120/1M)
  ('gemini-3.1-flash-image-preview', 'Gemini 3.1 Flash', 0.10, 30.00, 2.0),
  ('gemini-3-pro-image-preview', 'Gemini 3 Pro', 1.25, 120.00, 2.0),
  ...
  -- OpenRouter (Google Gemini) — OR adds markup on image output tokens
  ('google/gemini-3.1-flash-image-preview', 'OR Gemini 3.1 Flash', 0.50, 60.00, 2.0),
  ('google/gemini-3-pro-image-preview', 'OR Gemini 3 Pro', 2.00, 240.00, 2.0),
