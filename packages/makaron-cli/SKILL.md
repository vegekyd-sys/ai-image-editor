...
For MiniMax H3 Max, use `--video-model minimax-h3-max`; it supports exactly 5/10/15s at 480p/768p, with no image for T2V or exactly one image for I2V. It does not accept reference video/audio or multiple images.
