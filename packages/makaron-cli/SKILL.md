...
For Wan 3.0, use `--video-model wan-3.0`; it supports 2-30s generation at 480p/720p/1080p, up to 10 image + 5 video + 5 audio feature references, and native audio through Evolink. It does not expose typed edit/extend or a relaxed-content-filter flag.
