...
describe('agent prompt policy guards', () => {
  ...
  it('preserves full audio tool capabilities with a native-audio exception for direct video', () => {
    ...
    expect(agent).toContain('Otherwise those tools retain full scope')
    ...
    expect(agentTs).toContain('dry isolated speech stem')
    expect(agentTs).toContain('Compatibility alias for music-only callers')
