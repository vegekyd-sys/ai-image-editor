...
describe('agent prompt policy guards', () => {
  ...
  it('keeps single video generation in the model duration range and routes longer requests to the director skill', () => {
    ...
    expect(animate).toContain('For SeeDance, if the script totals less than 4s, extend it to a compact 4s script instead of submitting a shorter duration')
    ...
    expect(animate).toContain('## Longer-Form Direction (16-30s)')
    ...
    expect(createVideo).not.toContain('isNsfwVideoIntent')
