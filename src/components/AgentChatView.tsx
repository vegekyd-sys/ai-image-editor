...
function EditPromptCard({ prompt, inputImages, editModel }: { prompt: string; inputImages?: string[]; editModel?: string }) {
  ...
  const modelLabels: Record<string, string> = { gemini: 'nano banana 2', 'gemini-lite': 'nano banana 2 lite', qwen: 'qwen edit', 'qwen-spicy': 'qwen spicy', pony: 'pony anime', wai: 'wai illustrious', openai: 'OpenAI Image 2', 'gpt-image-2.5-flare': 'GPT Image 2.5 Flare', 'gpt-image-2.5-sunburst': 'GPT Image 2.5 Sunburst', 'wan2.7-image': 'Wan 2.7 Image' };
