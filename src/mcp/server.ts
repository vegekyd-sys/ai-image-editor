...
Style: Cinematic, warm golden light.`,
    {
      ...
      videoModel: z.enum(['seedance-fast', 'seedance-mini', 'seedance', 'seedance-2.5', 'wan-3.0', 'wan-3.0-prime', 'kling', 'grok', 'google-omni', 'minimax-h3', 'sync-lipsync-v3']).optional().describe('Video model. Use wan-3.0 for Standard or wan-3.0-prime for Prime/Fast/lower latency. Select 2k/4k through videoResolution to use the matching FlashVSR endpoint automatically; there is no separate Pro model. sync-lipsync-v3 requires exactly one video and one replacement audio track.'),
