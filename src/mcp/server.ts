...
- Resolution: omit or use "auto" for the selected model default. Seedance 2.5 supports 480p/720p; minimax-h3 supports 768p/2k and defaults to 2k; seedance-fast/seedance-mini/grok support 480p/720p; seedance supports 480p/720p/1080p; kling supports 720p/1080p/4k; google-omni outputs 720p.
...
- minimax-h3 — MiniMax H3 direct API, native text-to-video plus up to 9 image / 3 video / 3 audio references, 4-15s, public 768p/2K, default 2K
...
Style: Cinematic, warm golden light.`,
    {
      ...
      videoModel: z.enum(['seedance-fast', 'seedance-mini', 'seedance', 'seedance-2.5', 'kling', 'grok', 'google-omni', 'minimax-h3']).optional().describe('Video model. seedance-2.5 supports 30s multimodal generation/edit/extend; minimax-h3 provides native 2K multimodal generation.'),
      videoResolution: z.enum(['auto', '480p', '720p', '768p', '1080p', '2k', '4k']).optional().describe('Output resolution. Use auto to follow the selected model default; MiniMax H3 supports 768p/2k and defaults to 2k.'),
