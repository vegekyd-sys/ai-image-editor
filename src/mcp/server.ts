...
Style: Cinematic, warm golden light.`,
    {
      ...
      videoResolution: z.enum(['auto', '360p', '480p', '720p', '768p', '1080p', '2k', '4k']).optional().describe('Shared output-resolution control for every video model. Use auto to follow the selected model default and otherwise choose a supported value from the complete request and current app selection. Grok Imagine Video 1.5 supports text-to-video at 480p/720p/1080p and caps every image/voice reference request at 720p; Gemini Omni 1.1 supports 360p/720p/1080p/4k; MiniMax H3 supports 768p/2k.'),
