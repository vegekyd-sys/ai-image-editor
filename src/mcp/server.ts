...
- Resolution: omit or use "auto" for the selected model default. wan-3.0 and wan-3.0-prime expose 480p/720p/1080p/2k/4k; 2k/4k automatically use the matching FlashVSR/Pro endpoint. fal-h3-max and minimax-h3-max support 480p/768p and default to native 768p; minimax-h3-max uses the Turbo route; minimax-h3 supports 768p/2k and defaults to 768p. Gemini Omni supports 360p/720p/1080p/4k; Seedance 2.5 supports 480p/720p; Grok text-to-video supports 480p/720p/1080p and caps image/voice references at 720p.
...
- fal-h3-max — default fal H3 Max, native text-to-video or image/video/audio reference-to-video, integer 5-15s, 480p/768p, default 768p; reference inputs may cost extra
