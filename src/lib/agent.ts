  ...
  return {
    generate_image: tool({
      ...
      inputSchema: z.object({
        ...
        model: z.enum(['gemini', 'qwen', 'pony', 'wai']).optional().describe('Only pass when user EXPLICITLY names a model (e.g. "用pony", "use wai"). qwen for NSFW/Gemini-refused. Do NOT auto-detect anime style. Default: omit (auto-route).'),
