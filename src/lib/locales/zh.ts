const zh = {
  ...
  'model.grok45.desc': '反应快，擅长知识工作与多步工具任务。',
  ...
  'kids.parent.signIn': '家长登录并返回十二版',
  'kids.parent.mode.live': '实时模式 · Gemini Live',
  'kids.parent.mode.fallback': '兼容模式 · 火山语音 + Makaron Agent',
  'kids.parent.operator.idle': 'Operator 已连接；只有明确的创作请求才会交给现有 Makaron Agent。',
  'kids.parent.operator.queued': '图片请求已接单，Live 对话可以继续。',
  'kids.parent.operator.working': 'Makaron Agent 正在后台生成图片。',
  'kids.parent.operator.done': '新图片已完成并显示在主画面。',
  'kids.parent.operator.error': '图片任务未完成，请由可信任的成人检查账号或服务状态。',
} as const;
