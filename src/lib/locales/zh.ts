const zh = {
  ...
  'changelog.minimaxH3Max.title': 'MiniMax H3 Max 近乎实时视频',
  'changelog.minimaxH3Max.item1': '由 fal 提供的 MiniMax H3 Max 现已上线 Makaron，5 秒 480P 视频可以近乎实时生成，并支持文字生成视频和单张首帧生成视频。',
  ...
  'model.minimaxH3Max.desc': '接近实时生成 5–15 秒视频，支持 480P / 原生 768P 文生视频或单图生视频。',
