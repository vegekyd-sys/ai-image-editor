const zh = {
  ...
  'mediaPricing.sample5s': "5 秒价格示例",
  'mediaPricing.cancel': "取消编辑",
  'mediaPricing.editPrice': "编辑价格",
  'mediaPricing.sharedDatabase': "这里连接共享数据库，保存会更新实际计费价格。",
  'mediaPricing.category': "媒体类型",
  'mediaPricing.video': "视频",
  'mediaPricing.audio': "音频",
  'mediaPricing.searchModels': "搜索模型",
  'mediaPricing.empty': "暂无已登记价格",
  'mediaPricing.noModels': "未找到模型",
  'mediaPricing.sampleExplanation': "示例仅含 5 秒输出，不含参考素材费用或特殊模式加价。",
  'mediaPricing.description': "实际扣费直接读取此表。美元成本 × 加价倍率换算 Credits，整次任务向上取整；修改对后续报价生效，已预扣任务保留原报价。",
  'mediaPricing.included': "ASR、渲染与存储尚未单独计费；个人套餐用量单独记录，不重复扣 Credits。",
  'mediaPricing.refresh': "刷新",
  'mediaPricing.model': "模型",
  'mediaPricing.variant': "分辨率 / 操作",
  'mediaPricing.output_usd_per_second': "输出 USD/秒",
  'mediaPricing.input_usd_per_second': "参考视频 USD/秒",
  'mediaPricing.input_usd_per_image': "参考图 USD/张",
  'mediaPricing.free_image_references': "免费参考图数",
  'mediaPricing.input_usd_per_1k_tokens': '参考输入单价（美元 / 千 token）',
  'mediaPricing.free_input_tokens': '共享免费参考 token',
  'mediaPricing.input_tokens_per_image_pixel': '每图片像素 token',
  ...
  'mediaPricing.saved': "已保存",
  'mediaPricing.error': "价格不可用或保存失败，请检查迁移配置后重试。",
  'mediaPricing.conflict': "价格已被他人修改，请刷新后重试。",
  'mediaPricing.loading': "加载价格…",
  'mediaPricing.generate': "生成",
  'mediaPricing.edit': "编辑",
  'mediaPricing.extend': "续写",
  'mediaPricing.fixedTitle': "按次工具价格",
  'mediaPricing.fixedDescription': "下表用于按次收费；视频和 Seed Audio 使用上方多维价目，LLM 与 token 型图片使用下方 Token Rates。",
  'mediaPricing.quoteUnavailable': "暂时无法报价",
  'mediaPricing.quoteCredits': "预计 {credits} Credits",
  // Auth
  'auth.email': '邮箱',
  'auth.password': '密码',
  'auth.login': '登录',
  ...
  'changelog.gpt6AgentModels.item1': 'Agent 现在默认选中 GPT-6 Luna；需要处理更复杂的任务时，也可以选择 GPT-6 Sol。',
  'changelog.gpt6AgentModels.item2': '两款模型都可通过 Codex 订阅使用。GPT-5.6 已从页面选择器隐藏，已有项目仍可继续使用。',
  ...
  'changelog.gptImage25.item3': 'GPT Image 2.5 Flare 已替代原 Image 2，产品图、信息图等设计任务会自动使用。你也可以在图片模型中选择 Flare 或 Sunburst，或直接告诉 Agent「用 GPT Image 2.5」。',
  ...
  'changelog.minimaxH3Max.item1': '由 fal 提供的 MiniMax H3 Max Turbo 现已上线 Makaron，默认以原生 768P 超实时生成 5 秒视频，并支持文字生成视频和单张首帧生成视频。',
  ...
  'canvas.falH3MaxUsuallyTakes': '通常几十秒；带视频参考可能需 1–2 分钟',
  'canvas.grokUsuallyTakes': '通常 15–60 秒',
  'agentPage.videoTimingNote': '视频耗时因模型而异：fal 通常几十秒，Max 带视频参考可能需 1–2 分钟；排队和保存时间可能变化。Remotion 请使用：',
  ...
  'model.qwenSpicy.desc': '独立的 1–3 图编辑模型，变化大胆并保留高分辨率。',
  'model.image25Flare.name': 'GPT Image 2.5 Flare',
  'model.image25Flare.desc': '快速生成，适合日常创作',
  'model.image25Sunburst.name': 'GPT Image 2.5 Sunburst',
  'model.image25Sunburst.desc': '精细编辑，适合复杂修改',
  ...
  'model.wan30.desc': '支持 2–30 秒、原生音频和多模态参考；选择 2K / 4K 时自动启用 FlashVSR 超分。',
  'model.wan30.badge': '4K · 30s',
  'model.wan30Prime.name': 'Wan 3.0 Prime',
  'model.wan30Prime.desc': '更快的 Wan 3.0，支持 2–30 秒、原生音频和多模态参考；2K / 4K 自动启用 Prime FlashVSR。',
  ...
  'model.gpt6Luna.desc': '快速、低成本的日常创作默认模型。',
  'model.gpt6Sol.name': 'GPT-6 Sol',
  'model.gpt6Sol.desc': '适合复杂 Agent 任务与创作的更强模型。',
  'model.gpt56Terra.name': 'GPT-5.6 Terra',
  'model.gpt56Terra.desc': '兼顾智能、速度与成本。',
  ...
  'admin.personalAllowlist.tab': "个人套餐",
  'admin.personalAllowlist.title': '测试账号 Allowlist',
  'admin.personalAllowlist.desc': "一份名单，共用 Codex 与 Grok 个人套餐。默认 Agent 为 GPT-6 Luna（Azure API）；选择 Grok 时使用 Grok 套餐。凭证和额度独立，API 回退按量计费。",
  'admin.personalAllowlist.emailPlaceholder': '输入已注册的 Makaron 邮箱',
  'admin.personalAllowlist.add': '添加账号',
  'admin.personalAllowlist.saving': '同步中…',
  'admin.personalAllowlist.added': "账号已加入个人套餐名单，并同步到 Codex 与 Grok",
  'admin.personalAllowlist.removed': "账号已从两个个人套餐名单移除",
  'admin.personalAllowlist.updateFailed': "两个套餐未能全部同步。请检查状态并重试，同步成功前请勿视为已开通或撤销。",
  'admin.personalAllowlist.owner': 'Owner',
  'admin.personalAllowlist.allowed': "名单内",
  'admin.personalAllowlist.remove': '移除',
  'admin.personalAllowlist.unknownEmail': '未知邮箱',
  'admin.personalAllowlist.sync': "同步两个套餐",
  'admin.personalAllowlist.synchronized': "Codex 与 Grok 名单已同步",
  'admin.personalAllowlist.synced': "已同步",
  'admin.personalAllowlist.pending': "待同步",
  'admin.personalAllowlist.unavailable': "无法确认",
  'admin.personalAllowlist.checking': "检查中…",
  'admin.personalAllowlist.accountNotFound': "未找到已注册的 Makaron 账号",
  'admin.personalAllowlist.loadFailed': "无法读取个人套餐名单，请刷新重试。",
  ...
  'changelog.videoReplication.title': '视频复刻：换掉内容，保留原片',
  'changelog.videoReplication.item1': '上传一条参考视频，再加上人物、商品或场景图片，只需用一句普通的话说明要替换什么，Makaron Agent 就会理解整条视频并准备复刻。',
  'changelog.videoReplication.item2': '复刻会尽量保留原片的镜头顺序、时长、构图、运镜、动作、转场与声音结构，同时把指定人物、物体或背景换成新素材。',
  'changelog.videoReplication.item3': '短视频复刻默认使用 Wan 3.0 Prime 720p；Makaron 会按模型分别检查参考素材和输出时长，并在超限时先拆分视频。',
  ...
  'changelog.cliRunCredits.title': 'CLI 每次调用的花费一目了然',
  'changelog.cliRunCredits.item1': '每次 makaron chat 结束时都会显示本次消耗的 credits，按 Agent 与各工具拆分，并附上剩余余额。',
  'changelog.cliRunCredits.item2': '之后可用 makaron usage --run 或 --project 回看用量；JSON 结果里也带同样的 usage 数据，方便自动化对账。',
  'changelog.sceneImportReliability.title': 'Scene 素材成片更可靠',
  'changelog.sceneImportReliability.item1': '从 Scene 导入 HEIC 照片时自动转换，可直接通过 CLI 与视频片段混剪。',
  'changelog.sceneImportReliability.item2': '照片与动态编排的视频片段混剪时，导出会保留完整时间线，避免成片被提前截短。',
  ...
  'model.agentAutoDesc': '默认 GPT-6 Luna，走 Azure API',
