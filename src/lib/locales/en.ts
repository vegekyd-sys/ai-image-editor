const en = {
  ...
  'model.sonnet46.desc': 'Fast and stable for everyday edits and tool use.',
  'model.sonnet5.name': 'Sonnet 5',
  'model.sonnet5.desc': 'Default balance for complex work, speed, and cost.',
  'model.opus48.name': 'Opus 4.8',
  'model.opus48.desc': 'Strongest complex reasoning and creation, at higher cost.',
  ...
  'model.agentAutoDesc': 'Follow the recommended default, currently Sonnet 5',
