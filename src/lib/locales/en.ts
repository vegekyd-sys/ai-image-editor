const en = {
  ...
  'model.kling.desc': 'Supports 720p/1080p/4K, fast, with built-in sound.',
  'model.seedanceFast.name': 'SeeDance 2.0 Fast',
  'model.seedanceFast.desc': 'Default video model. 480p/720p with better speed and cost for daily generation.',
  'model.seedance.name': 'SeeDance 2.0',
  'model.seedance.desc': 'Standard high-quality model. Supports 480p/720p/1080p and costs more.',
