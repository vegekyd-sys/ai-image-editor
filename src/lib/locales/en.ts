const en = {
  ...
  'changelog.minimaxH3Max.title': 'Near-Real-Time Video with MiniMax H3 Max',
  'changelog.minimaxH3Max.item1': 'MiniMax H3 Max by fal is now live in Makaron, generating five-second 480P videos at near-real-time speed from text or a single start image.',
  ...
  'model.minimaxH3Max.desc': 'Near-real-time 5–15 second text-to-video or single-image-to-video at 480P or native 768P.',
