const en = {
  ...
  'kids.phase.parent': 'A parent needs to sign in first',
  ...
  'kids.parent.signIn': 'Parent sign in and return to Kids',
  'kids.parent.mode.live': 'Live mode · Gemini Live',
  'kids.parent.mode.fallback': 'Compatible mode · Volcengine voice + Makaron Agent',
