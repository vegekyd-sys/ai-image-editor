const en = {
  ...
  'mediaPricing.input_usd_per_1k_tokens': 'Reference input USD / 1K tokens',
  'mediaPricing.free_input_tokens': 'Pooled free reference tokens',
  'mediaPricing.input_tokens_per_image_pixel': 'Tokens per image pixel',
  ...
  'changelog.gpt6AgentModels.item1': 'Agent now defaults to GPT-6 Luna with High reasoning. Choose GPT-6 Sol for more complex work.',
  ...
  'canvas.falH3MaxUsuallyTakes': 'Usually tens of seconds; video references may take 1–2 minutes',
  'canvas.grokUsuallyTakes': 'Usually takes 15–60 seconds',
  'agentPage.videoTimingNote': 'Timing varies by model: fal usually takes tens of seconds; Max with video references may take 1–2 minutes. Queuing and saving can vary. Use these commands for Remotion:',
  ...
  'model.image25Sunburst.desc': 'Precise editing for complex changes',
  ...
  'model.falH3Max.desc': 'Generate with image, video and audio references. Native 768P by default, optional 1080P, 5–15 seconds.',
  'model.gpt6Luna.name': 'GPT-6 Luna',
  'model.gpt6Luna.desc': 'Fast, affordable default for everyday creative work.',
  'model.gpt6Sol.name': 'GPT-6 Sol',
  'model.gpt6Sol.desc': 'More capable for complex agent and creative work.',
  'model.gpt56Terra.name': 'GPT-5.6 Terra',
  'model.gpt56Terra.desc': 'Balances intelligence, speed, and cost.',
  ...
  'admin.personalAllowlist.desc': "One allowlist for Codex and Grok. GPT-6 Luna is the default Agent through Azure API; selecting Grok uses the Grok plan. Credentials and quotas stay separate; API fallback is billed by usage.",
  ...
  'changelog.cliRunCredits.title': 'See What Every CLI Run Costs',
  'changelog.cliRunCredits.item1': 'Every makaron chat now ends with the credits it used, broken down by Agent and tools, plus your remaining balance.',
  'changelog.cliRunCredits.item2': 'Use makaron usage --run or --project to review credit usage later; JSON results include the same usage data for automation.',
  'changelog.sceneImportReliability.title': 'More Reliable Scene Video Creation',
  'changelog.sceneImportReliability.item1': 'Import HEIC photos from Scene without manual conversion, and mix them with video clips through the CLI.',
  'changelog.sceneImportReliability.item2': 'Video exports now preserve the full intended timeline when photos and dynamically arranged clips are mixed.',
  ...
  'model.agentAutoDesc': 'Use the default GPT-6 Luna through Azure API',
