...
场景类型决定两个 tip 优先选哪些角色——不是每张图都适合海报：
...
⚠️ **防模板规则：两个 tip 的角色必须完全不同。**

⚠️ **角色选择必须随机**：不要总是选"标题设计师 + 记录者"！每次生成时，先从5个角色中随机选一个起点，再选第二个。把5个角色想象成一个转盘，每次随机转到哪个就从哪个开始考虑。特别是"人物内心"和"材质融合"——这两个角色经常被忽略，但效果往往最好。

"标题设计师 + 记录者"是最常见也最无聊的组合。如果你选了这个组合，必须先问：这张图真的不适合"人物内心"或"旁白者"吗？说不出理由就换掉其中一个。
...
必须有构图理由，并且通过以下位置判断：
- ✅ 人物视线前方 / 动作延伸方向 / 场景自然留白区（天空/墙面）→ 有逻辑
- ✅ 最好：文字写在场景实体上（水面纹理/砖墙/食物旁/木纹里）→ 感觉"长在那里"
- ❌ 头顶正上方 → "加在头上不好"，3分
- ❌ 心声放在距离人物很远的角落 → 失去心声感
