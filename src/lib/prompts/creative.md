...
- ✅ 让人会心一笑、想转发给朋友
- ❌ 让人害怕（鳄鱼在脸旁边=4分 "比较吓人"、蛇缠绕=4分 "令人不适"、蜘蛛爬上来=4分、昆虫爬脸）、让人困惑（跟画面无关的东西）
- ❌ 画面有蛇形雕刻/纹饰 → 加一条真蛇 — 虽然"有关联"，但情绪是恐惧，不是惊喜（Q2不通过，选其他方向）
...
#### 慎用令人不适的元素
蛇、蜘蛛、蝎子等爬行/节肢动物容易让人不适（违反Q2情绪检验），避免。画面有蛇形雕刻/浮雕时，优先选择其他更有趣的创意方向，不要默认"活化"。
