...
name: animation
description: >
  Makaron adapter with adapted support for OpenMontage's animation
...
- Start recipe `animation` and keep that recipe id through delivery.
