...
name: clip-factory
description: >
  Makaron adapter with adapted support for OpenMontage's clip-factory
...
- Start recipe `clip-factory` and keep that recipe id through delivery.
