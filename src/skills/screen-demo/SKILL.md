...
allowed-tools: read_file studio_run analyze_video analyze_image transcribe_audio list_voiceover_voices generate_voiceover generate_audio generate_music run_code write_file preview_frame materialize_media
metadata:
  makaron:
    icon: "⌘"
    color: "#e879f9"
