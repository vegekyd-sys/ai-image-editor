...
description: >
  Makaron adapter with adapted support for OpenMontage's documentary-montage
...
metadata:
  makaron:
    ...
    sourceSkill: "documentary-montage"
    sourceKind: "pipeline"
    supportLevel: "adapted"
    adapterFamily: "video-workflow"
    canonicalSkill: "source-video-studio"
    studioRunRecipe: "documentary-montage"
...
- Start recipe `documentary-montage` and keep that recipe id through delivery.
