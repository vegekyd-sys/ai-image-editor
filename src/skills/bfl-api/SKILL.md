...
name: bfl-api
description: >
  Makaron adapter with adapted support for OpenMontage's bfl-api
...
- Reuse FLUX prompting ideas, structured references, typography discipline, and color constraints through an available Makaron image model; do not claim BFL API execution.
