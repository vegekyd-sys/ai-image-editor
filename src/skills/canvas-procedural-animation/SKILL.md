...
allowed-tools: read_file studio_run analyze_image analyze_video generate_image generate_audio generate_music list_voiceover_voices generate_voiceover run_code write_file preview_frame materialize_media
metadata:
  makaron:
    icon: "人"
    color: "#d946ef"
