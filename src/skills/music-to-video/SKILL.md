...
name: music-to-video
description: >
  Turn a supplied song, beat, or voice track into an editable audio-led video
  whose cuts, motion, typography, and visual energy follow the music. Use when
  the original audio is the timing authority rather than background decoration.
...
metadata:
  makaron:
    ...
    inputHint: "A song, beat, or voice recording that defines the timing"
