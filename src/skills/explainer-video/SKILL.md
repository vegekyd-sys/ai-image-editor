...
allowed-tools: read_file studio_run prepare_visual_asset run_code write_file preview_frame materialize_media transcribe_audio generate_audio generate_image analyze_image analyze_video
metadata:
  makaron:
    icon: "🎙️"
    color: "#8b5cf6"
