...
allowed-tools: read_file studio_run prepare_visual_asset analyze_video transcribe_audio analyze_image generate_image generate_audio run_code write_file preview_frame materialize_media
metadata:
  makaron:
    icon: "✂"
    color: "#d946ef"
