...
name: doubao-tts
description: >
  Makaron adapter with native support for OpenMontage's doubao-tts
...
- Treat the requested capability as voiceover intent, not as a provider choice.
  Read `prompts/audio.md` and use
  `generate_audio({ kind: "voiceover", ... })`; all new narration is generated
  by Seed Audio.
