...
name: seedance-2-0
description: >
  Makaron adapter with native support for OpenMontage's seedance-2-0
...
- Map standard/full/premium Seedance 2.0 to model `seedance`, fast to `seedance-fast`, and low-cost draft/mini to `seedance-mini`. Seedance supports native text-to-video, image references, video references, and audio references within Makaron capability limits.
