...
description: >
  Makaron adapter with adapted support for OpenMontage's podcast-repurpose
...
metadata:
  makaron:
    ...
    sourceSkill: "podcast-repurpose"
    sourceKind: "pipeline"
    supportLevel: "adapted"
    adapterFamily: "video-workflow"
    canonicalSkill: "content-repurpose"
    studioRunRecipe: "podcast-repurpose"
...
2. Read `skills/content-repurpose/SKILL.md` and use it as the execution contract.
...
- Start recipe `podcast-repurpose` and keep that recipe id through delivery.
