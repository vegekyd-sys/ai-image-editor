...
- Treat text-to-speech as voiceover intent, not as a provider choice. Read
  `prompts/audio.md` and use `generate_audio({ kind: "voiceover", ... })`; all
  new narration is generated by Seed Audio.
