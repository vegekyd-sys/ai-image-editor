...
name: ltx2
description: >
  Makaron adapter with adapted support for OpenMontage's ltx2
...
- Preserve the requested shot and motion intent through an available Makaron video model; do not claim LTX-2 execution.
