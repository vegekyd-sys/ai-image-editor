...
description: >
  Makaron adapter with adapted support for OpenMontage's playwright-recording
...
metadata:
  makaron:
    ...
    sourceSkill: "playwright-recording"
    sourceKind: "agent-skill"
    supportLevel: "adapted"
    adapterFamily: "video-workflow"
    canonicalSkill: "screen-demo"
    tags: [openmontage, agent-skill, video-workflow, adapted]
---
...
- Use uploaded capture when available. If browser capture is unavailable in the current runtime, switch only to an explicitly labeled synthetic UI/terminal mode or request a recording.
