...
description: >
  Makaron adapter with adapted support for OpenMontage's animated-explainer
...
metadata:
  makaron:
    ...
    sourceSkill: "animated-explainer"
    sourceKind: "pipeline"
    supportLevel: "adapted"
    adapterFamily: "video-workflow"
    canonicalSkill: "explainer-video"
    studioRunRecipe: "animated-explainer"
...
2. Read `skills/explainer-video/SKILL.md` and use it as the execution contract.
...
- Start recipe `animated-explainer` and keep that recipe id through delivery.
