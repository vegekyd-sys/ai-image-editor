...
description: >
  Makaron adapter with adapted support for OpenMontage's flux-best-practices
...
metadata:
  makaron:
    ...
    sourceSkill: "flux-best-practices"
...
- Reuse FLUX prompt craft through an available Makaron image model; model-specific FLUX endpoints and parameters are not exposed.
