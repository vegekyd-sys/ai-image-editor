...
description: >
  Makaron adapter with adapted support for OpenMontage's gsap-scrolltrigger
...
metadata:
  makaron:
    ...
    sourceSkill: "gsap-scrolltrigger"
...
- For video, convert scroll progress into deterministic frame progress; do not depend on a live page scroll position during rendering.
