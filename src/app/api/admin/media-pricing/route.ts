...
const updateSchema = z.object({
  ...
  input_usd_per_1k_tokens: z.number().finite().nonnegative().max(1000000).optional(),
  free_input_tokens: z.number().finite().nonnegative().max(1000000).optional(),
  input_tokens_per_image_pixel: z.number().finite().nonnegative().max(1000000).optional(),
  input_tokens_per_video_second: z.number().finite().nonnegative().max(1000000).optional(),
  input_tokens_per_audio_second: z.number().finite().nonnegative().max(1000000).optional(),
