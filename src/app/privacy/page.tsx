...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      'Depending on the feature and model you select, recipients may include Google (Gemini), OpenAI and Microsoft (Azure OpenAI), Anthropic and Amazon Web Services (Bedrock), DeepSeek, xAI, ByteDance/Volcengine (SeeDance), Kuaishou/Kling, Hugging Face and fal.ai, and SunoAPI.org. Processing gateways may include OpenRouter, PiAPI, and Evolink.',
