...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      'Depending on the feature and model you select, recipients may include Google (Gemini), OpenAI and Microsoft (Azure OpenAI), DeepSeek, xAI, ByteDance/Volcengine (SeeDance), Kuaishou/Kling, and MiniMax.',
